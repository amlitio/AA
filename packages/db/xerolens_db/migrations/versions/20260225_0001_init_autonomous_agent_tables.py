...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("tenant_id", sa.String(length=128), nullable=False),
        sa.Column("field_ticket_number", sa.String(length=128), nullable=False),
        sa.Column("packet_total", sa.Numeric(12, 2), nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("tenant_id", sa.String(length=128), nullable=False),
        sa.Column("xero_invoice_id", sa.String(length=128), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("case_type", sa.String(length=64), nullable=False, server_default="GENERAL"),
...
def downgrade() -> None:
    ...
    op.drop_table("cases")
    op.drop_table("invoice_index")
    op.drop_table("field_tickets")
